...
plot
ggsave2(filename = "Plot-01.pdf", units = "cm"
        , width = 30, height = 15)
```
### Insertar grafico como imagen 
...
my_data <- fb[, c("lfa", "hi", "leafdw", "wue", "op_84")]
png("correlation_plot.png")  # Guardamos el gráfico como imagen
chart.Correlation(my_data, histogram = TRUE, pch = 19)
dev.off()

# Carga el gráfico de correlación como una imagen en cowplot
p4 <- ggdraw() + draw_image("correlation_plot.png")

# Organiza los cuatro gráficos en una cuadrícula 2x2
